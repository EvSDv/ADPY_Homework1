...
a.add_contact('Audley', 'Kingsman', '+2029398907', True, '+12025912173', telegram='@kingsman', email='kingsman@smith.com', test='Kingsman Audley')

# a.show_contacts()
# a.del_contact('+71234567809')
# a.search_favorite_contact()
# a.search_contact_by_name('Audley', 'Kingsman')
